...
pub static EXTENDEDPOINT_IDENTITY: ExtendedPoint = ExtendedPoint(FieldElement2625x4([
...
pub static CACHEDPOINT_IDENTITY: CachedPoint = CachedPoint(FieldElement2625x4([
...
/// ```
pub static P_TIMES_2_LO: u32x8 = u32x8::new(
    67108845 << 1,
    67108845 << 1,
    33554431 << 1,
    33554431 << 1,
...
/// (2p, 2p, 2p, 2p) = [P_TIMES_2_LO, P_TIMES_2_HI, P_TIMES_2_HI, P_TIMES_2_HI, P_TIMES_2_HI]
/// ```
pub static P_TIMES_2_HI: u32x8 = u32x8::new(
    67108863 << 1,
    67108863 << 1,
    33554431 << 1,
    33554431 << 1,
...
/// ```
pub static P_TIMES_16_LO: u32x8 = u32x8::new(
    67108845 << 4,
    67108845 << 4,
    33554431 << 4,
    33554431 << 4,
...
/// (16p, 16p, 16p, 16p) = [P_TIMES_16_LO, P_TIMES_16_HI, P_TIMES_16_HI, P_TIMES_16_HI, P_TIMES_16_HI]
/// ```
pub static P_TIMES_16_HI: u32x8 = u32x8::new(
    67108863 << 4,
    67108863 << 4,
    33554431 << 4,
    33554431 << 4,
